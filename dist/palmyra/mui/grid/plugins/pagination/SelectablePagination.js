...
import '../../../../../assets/SelectablePagination.css';const C = y(10), E = (a) => {
  ...
  const o = (t == null ? void 0 : t.getTotalRecords()) || 0, h = (t == null ? void 0 : t.getQueryLimit()) || { limit: 15 }, s = Array.isArray(a.pageSize) ? a.pageSize : [a.pageSize], c = (t == null ? void 0 : t.getPageNo()) || 0, l = h.limit || 25, r = Math.ceil(o / l), u = c * l + 1, b = Math.min((c + 1) * l, o), f = (n, i) => {
    t.gotoPage(i - 1);
  }, v = (n) => {
