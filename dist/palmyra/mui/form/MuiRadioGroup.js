...
function b(d) {
  return E({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "currentColor" }, child: [{ tag: "path", attr: { d: "M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM12 16C14.2091 16 16 14.2091 16 12C16 9.79086 14.2091 8 12 8C9.79086 8 8 9.79086 8 12C8 14.2091 9.79086 16 12 16Z" }, child: [] }] })(d);
}
const K = j(function(e, u) {
  const o = y(e.attribute, e), { getError: g, getValue: F, setValue: v, mutateOptions: R, refreshError: x } = o, O = u || m(null), c = g(), M = e.flexDirection != "column", n = m(null);
  z(O, () => ({
    ...H(o),
    focus() {
      n.current.focus();
  ...
  i.onChange = (t, l) => {
    e.readOnly || (v(t.target.value), e.onChange && e.onChange(t, l));
  }, i.onBlur = x;
  const q = (t) => {
    if (t) {
  ...
  return /* @__PURE__ */ r(G, { children: !R.visible && /* @__PURE__ */ r(
    k,
    {
      label: D(e),
